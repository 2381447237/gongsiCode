package com.views.refresh.load;
 ...
 * @since 2013-8-16
 */
public abstract class Base_LoadingLayout extends FrameLayout implements I_LoadingLayout {
     ...
     */
    public Base_LoadingLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs attrs
     */
    public Base_LoadingLayout(Context context, AttributeSet attrs) {
     ...
     */
    public Base_LoadingLayout(Context context, AttributeSet attrs, int defStyle) {
