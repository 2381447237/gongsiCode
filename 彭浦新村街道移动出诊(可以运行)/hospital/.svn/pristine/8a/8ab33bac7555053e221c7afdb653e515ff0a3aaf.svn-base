package com.views.refresh;

import com.views.refresh.load.Base_LoadingLayout;
import com.views.refresh.load.I_LoadingLayout.State;
import com.views.refresh.load.imp.FooterLoadingLayout;
import com.views.refresh.load.imp.HeaderLoadingLayout;
 ...
 * @param <T>
 */
public abstract class Base_Refresh<T extends View> extends LinearLayout implements I_Refresh<T> {
    /**
     * 定义了下拉刷新和上拉加载更多的接口。
     * 
     * @author Li Hong
    ...
    public interface OnRefreshListener<V extends View> {
         ...
         */
        void onPullDownToRefresh(final Base_Refresh<V> refreshView);
         ...
         * @param refreshView 刷新的View
         */
        void onPullUpToRefresh(final Base_Refresh<V> refreshView);
    }
    ...
    /**下拉刷新的布局 */
    private Base_LoadingLayout mHeaderLayout;
    /**上拉加载更多的布局*/
    private Base_LoadingLayout mFooterLayout;
    /**HeaderView的高度*/
     ...
     */
    public Base_Refresh(Context context) {
        super(context);
        init(context, null);
    }
     ...
     * @param attrs attrs
     */
    public Base_Refresh(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     */
    @SuppressLint("NewApi")
	public Base_Refresh(Context context, AttributeSet attrs, int defStyle) {
    ...
    @Override
    public Base_LoadingLayout getHeaderLoadingLayout() {
        return mHeaderLayout;
    }
    
    @Override
    public Base_LoadingLayout getFooterLoadingLayout() {
     ...
     */
    protected Base_LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs) {
     ...
     * @return LoadingLayout对象
     */
    protected Base_LoadingLayout createFooterLoadingLayout(Context context, AttributeSet attrs) {
    ...
    protected void addHeaderAndFooter(Context context) {
        ...
        final Base_LoadingLayout headerLayout = mHeaderLayout;
        final Base_LoadingLayout footerLayout = mFooterLayout;
    ...
    protected void startRefreshing() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPullDownToRefresh(Base_Refresh.this);
                }
            }, getSmoothScrollDuration()); 
        }
    }
    ...
    protected void startLoading() {
        ...
        if (null != mRefreshListener) {
            ...
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    mRefreshListener.onPullUpToRefresh(Base_Refresh.this);
                }
            }, getSmoothScrollDuration()); 
        }
    }
    ...
    final class SmoothScrollRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (mContinueRunning && mScrollToY != mCurrentY) {
                Base_Refresh.this.postDelayed(this, 16);// SUPPRESS CHECKSTYLE
            }
        }
