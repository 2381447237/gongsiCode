...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private Date today; // 今天的日期文字显示红�?
	private Date downDate; // 手指按下状�?�时临时日期
	private Date showFirstDate, showLastDate; // 日历显示的第�?个日期和�?后一个日�?
	private int downIndex; // 按下的格子索�?
	private Calendar calendar;
	private Surface surface;
	private int[] date = new int[42]; // 日历显示数字
	private int curStartIndex, curEndIndex; // 当前显示的日历起始的索引
	private boolean completed = false; // 为false表示只�?�择了开始日期，true表示结束日期也�?�择�?
...
//		}
	...
	/**
	 * 
	 * 1. 布局尺寸 2. 文字颜色，大�? 3. 当前日期的颜色，选择的日期颜�?
	 */
	private class Surface {
		public float density;
		public int width; // 整个控件的宽�?
		public int height; // 整个控件的高�?
		public float monthHeight; // 显示月的高度
		//public float monthChangeWidth; // 上一月�?�下�?月按钮宽�?
		public float weekHeight; // 显示星期的高�?
