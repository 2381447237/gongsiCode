...
public class SizeAdapter extends BaseAdapter {
	...
	public static String AllSizeName = "";
	public static List<MySize> mySizeList = new ArrayList<MySize>();

	public SizeAdapter(ShopFragment context, String[] size) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context.getActivity()).inflate(
					R.layout.size, null);
			holder.btn_size = (Button) (convertView)
		...
		if (mySizeList.get(position).isSelected()) {
		...
		holder.btn_size.setText(mySizeList.get(position).getSizeType());
		...
		holder.btn_size.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				mySizeList.get(position).setSelected(
						!mySizeList.get(position).isSelected());
				...
				AllSizeName = "";
				for (MySize s : mySizeList) {

					if (s.isSelected())

						AllSizeName += s.getSizeType() + ",";
