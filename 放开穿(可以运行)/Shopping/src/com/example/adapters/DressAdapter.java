...
public class DressAdapter extends BaseAdapter {
	...
	public static List<MyDress> myDressList = new ArrayList<MyDress>();
	public static String AllProOptNameDress = "";

	public DressAdapter(ShopFragment context, String[] size) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(myDressList.get(position).isChecked()){
		...
		holder.btn_size.setText(myDressList.get(position).getDressSize());
		...
		holder.btn_size.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				myDressList.get(position).setChecked(!myDressList.get(position).isChecked());
				...
				for(MyDress md:myDressList){
					
					if(md.isChecked())
					 AllProOptNameDress+=md.getDressSize()+",";
				}
