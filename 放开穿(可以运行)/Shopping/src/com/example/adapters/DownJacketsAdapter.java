...
public class DownJacketsAdapter extends BaseAdapter {

	private ShopFragment context;
	private String[] size;
	GradientDrawable drawable;
	public static List<MyDownJackets> myDownJacketsList = new ArrayList<MyDownJackets>();
	public static String AllProOptNameDownJackets = "";

	public DownJacketsAdapter(ShopFragment context, String[] size) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (myDownJacketsList.get(position).isChecked()) {
		...
		holder.btn_size.setText(myDownJacketsList.get(position)
				.getDownJacketsSize());
		...
		holder.btn_size.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				myDownJacketsList.get(position).setChecked(
						!myDownJacketsList.get(position).isChecked());

				if (ShopFragment.isChangeCategory_Id == true) {
					AllProOptNameDownJackets = "";
				...
				for (MyDownJackets mdj : myDownJacketsList) {

					if (mdj.isChecked())
						AllProOptNameDownJackets += mdj.getDownJacketsSize()
								+ ",";
