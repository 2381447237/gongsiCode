package com.example.zxing.lib.core;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private static long ANIMATION_DELAY = 80l;

    private final int mDefaultLaserColor = getResources().getColor(R.color.viewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(R.color.viewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(R.color.viewfinder_border);
    private final int mDefaultLaserStrokeWidth = getResources().getInteger(R.integer.viewfinder_laser_width);
    ...
    private float mScanLineY;//扫描线的Y坐标
    private int mMoveStepDistance;//扫描线的Y坐标
    protected boolean mIsMoveScanLine;//是否移动扫描线
    ...
    private void init() {
        ...
        mLaserPaint.setStrokeWidth(mDefaultLaserStrokeWidth);
    ...
    public void setIsMoveScanLine(boolean mIsMoveScanLine) {
        this.mIsMoveScanLine = mIsMoveScanLine;
    }
    ...
    public void drawLaser(Canvas canvas) {
        ...
        if(!mIsMoveScanLine){
            ...
            canvas.drawRect(framingRect.left + 2, middle - 1, framingRect.right - 2, middle + 2, mLaserPaint);
            ANIMATION_DELAY=80l;
        }else{
            canvas.drawLine(framingRect.left+2,mScanLineY, framingRect.right-2, mScanLineY, mLaserPaint);
            mScanLineY+=mMoveStepDistance;
            if(mScanLineY>=framingRect.bottom)mScanLineY=framingRect.top;
            ANIMATION_DELAY=15l;
        }
