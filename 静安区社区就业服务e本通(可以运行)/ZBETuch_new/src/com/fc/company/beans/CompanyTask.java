...
public class CompanyTask {
	 ...
	 * 个人推荐
	 */
	public static final int RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN = 67;
	/**
	 * 推荐列表
	 */
	public static final int RECRUITMENT_RECURITMENTLISTDETAILACITYITY_TUIJIANLIEBIAO = 68;

	public static final int RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN_QUEDING = 69;

	/**
	 * 会议通知获取会议列表
	 */
	public static final int MEETINGPOST_MEETINGLISTACTIVITY_GET_MEETING_MASTER = 70;

	/**
	 * 会议通知详细页取得未读按钮状态
	 */
	public static final int MEETINGPOST_MEETINGLISTDETAILACTIVITY_SET_MEETING_CHECK = 71;

	/**
	 * 会议通知详细页面设置已读状态
	 */
	public static final int MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_CHECK = 72;

	/**
	 * 会议通知获取文件下载列表
	 */
	public static final int MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_FILE = 73;

	/**
	 * 会议通知查询下载列表
	 */
	public static final int MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_DOWNLOADITEM = 74;

	/**
	 * 首页获取会议列表
	 */
	public static final int FIRST_FIRSTPAGEACTIVITY_GET_MEETING_MASTER = 75;

	/**
	 * 会议通知获取当月读取数据
	 */
	public static final int MEETINGPOST_MEETINGLISTACTIVITY_GET_METTING_READ = 76;

	/**
	 * 得到会议记录数
	 */
	public static final int MEETINGPOST_MEETINGLISTACTIVITY_GET_MEETING_NUM = 77;

	/**
	 * 上传会议管理数据
	 */
	public static final int GUANLIACTIVITY_SET_MEET_DATA = 78;

	public static final int ERECORD_ERECORDACTIVITY_GET_ERECORDINFO = 79;

	public static final int MEETINGGUANLI_GET_MEETINGGUANLINUM = 80;

	public static final int DETEL_PERSON = 81;

	public static final int NUM_CENTER_INFO = 82;

	public static final int NUM_CENTER_NAME_IFNO = 83;

	public static final int WORK_INFO = 84;

	public static final int LOGIN_INFO = 85;

	public static final int WORKS_INFO = 86;

	public static final int MEETING_READ_GROUP = 87;

	public static final int WORK_READ_GROUP = 88;

	public static final int GRADEATE_EDITWORKMARKACTIVITY_GET_COMMITTEESTAFFLIST1 = 89;

	public static final int GRADEATE_EDITWORKMARKACTIVITY = 90;

	public static final int GRADENTPERSONINFOACTIVITY_GET_JUWEIHUILIST1 = 91;

	public static final int UPDATE_INFO = 92;

	public static final int ADD_INFO = 93;

	public static final int UPDATE_GRADEINFO = 94;

	public static final int ADD_GRADEINFO = 95;
