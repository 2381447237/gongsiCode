...
public class WorkQueryMainActivity extends Activity implements IActivity,
		OnItemClickListener {

	private GridView gv_workquery;
	private GridAdapter adapter;// 网格适配器
	private Button btn_select, btn_query;
	private int imgIds[] = new int[] { R.drawable.workquery_login,
			R.drawable.workquery_zpread, R.drawable.workquery_app };
