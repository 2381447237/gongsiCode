...
public class WorkQueryExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.activity_workquery_adapter_item, null);
		}
		TextView streetName = (TextView) convertView
				.findViewById(R.id.tv_workquery_gourp_street);
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		TextView committeeName = (TextView) convertView
				.findViewById(R.id.tv_workquery_gourp_street);
		convertView.setBackgroundResource(MainTools
				.getbackground1(childPosition));
		committeeName.setText(childInfo.get(groupPosition).get(childPosition)
				.getCommitteeName());
		return convertView;
	}
