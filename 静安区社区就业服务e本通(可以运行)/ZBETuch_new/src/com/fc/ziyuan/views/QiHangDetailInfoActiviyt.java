...
public class QiHangDetailInfoActiviyt extends Activity {
	...
	private EditText name, sex, sfz, born, tel, hkqx, mz, jg, age, whcd, hkjd,
			hkjw, fwdqx, fwdxxdz, fwdjd, fwdjw, jyzt, byrq, ldsc, dlzp,
			stldstartime, stldendtime, jylx, jysydjbh, jyfw1, jyfw2, jyfw3,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		qiHangBeanInfo = (QiHangBeanInfo) getIntent().getSerializableExtra(
				"infos");
