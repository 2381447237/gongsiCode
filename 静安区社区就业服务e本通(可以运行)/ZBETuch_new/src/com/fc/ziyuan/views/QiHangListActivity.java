...
public class QiHangListActivity extends Activity implements IActivity,
		OnPullDownListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resourcesInfo = (ResourcesInfo) getIntent().getSerializableExtra(
				"infos");
		init();
		initView();
		initPullDownView();
	...
	private void getPageList(int index) {
		...
		PersonTask task = new PersonTask(
				PersonTask.QIHANGDIAOCHAOACTIVITY_GET_INFOS, params);
	...
	private void initView() {
		...
		myPullDownView = (PullDownView) this
				.findViewById(R.id.my_detail_pulldownview);
	...
	public void refresh(Object... params) {
		...
		case REFRESH_INFO:
			...
			if (params[1].toString().trim() != null
				...
				List<QiHangBeanInfo> newHangBeanInfos = parseToJsonQiHangInfo(params[1]
						.toString().trim());
				...
				if (beanInfos.size() > 0) {
					lblNum.setText("总共" + beanInfos.get(0).getRecordCount()
							+ "条数据");
				} else {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case R.id.shiye_IdCard:
				...
				popupwindow = MainTools.showPopupWindow(
						QiHangListActivity.this, popupwindow, idcardText);
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			// TODO Auto-generated method stub
			if ("".equals(idcardText.getText().toString().trim())
					|| idcardText.getText().toString().trim() == null) {
				Toast.makeText(QiHangListActivity.this, "身份证号不能为空",
						Toast.LENGTH_LONG).show();
				return;
			}
			if (idcardText.getText().toString().trim().length() != 18) {
				Toast.makeText(QiHangListActivity.this, "请输入18位身份证号",
						Toast.LENGTH_LONG).show();
				return;
			}
			Map<String, Object> params = new HashMap<String, Object>();
			...
			params.put("data", data);
			PersonTask task = new PersonTask(
					PersonTask.QIHANGACTIVITY_GET_SFZ_IFNO, params);
			PersonService.newTask(task);
		}
	...
	private class MyOnitemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int location,
				long arg3) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(QiHangListActivity.this,
					QiHangDetailActivity.class);
			QiHangBeanInfo bean = beanInfos.get(location - 1);
			System.out.println(bean);
			intent.putExtra("beanInfos",
					(Serializable) beanInfos.get(location - 1));
			// System.out.println(">>>>>" + beanInfos.get(location - 1));
	...
	private List<QiHangBeanInfo> parseToJsonQiHangInfo(String str) {
		...
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				beanInfo.setUNDO(object.getString("UNDO"));
				...
				beanInfo.setNEW_XWYX(object.getString("NEW_XWYX"));
				beanInfo.setNEW_WQJY(object.getString("NEW_WQJY"));
				beanInfo.setNEW_JYFW1(object.getString("NEW_JYFW1"));
				beanInfo.setNEW_JYFW2(object.getString("NEW_JYFW2"));
				beanInfo.setNEW_JYFW3(object.getString("NEW_JYFW3"));
				beanInfo.setNEW_XWCS1(object.getString("NEW_XWCS1"));
				beanInfo.setNEW_XWCS2(object.getString("NEW_XWCS2"));
				beanInfo.setNEW_XWCS3(object.getString("NEW_XWCS3"));
				beanInfo.setNEW_XWPX1(object.getString("NEW_XWPX1"));
				beanInfo.setNEW_XWPX2(object.getString("NEW_XWPX2"));
				beanInfo.setNEW_XWPX3(object.getString("NEW_XWPX3"));
