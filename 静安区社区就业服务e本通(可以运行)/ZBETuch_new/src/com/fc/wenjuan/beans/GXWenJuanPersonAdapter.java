...
public class GXWenJuanPersonAdapter extends BaseAdapter {

	private List<WenJuanPersonInfo> infos;
	private Context context;
	public GXWenJuanPersonAdapter(List<WenJuanPersonInfo> infos, Context context) {
		super();
		this.infos = infos;
	...
	public View getView(int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			holdItem.tv_jtcys=(TextView) view.findViewById(R.id.tv_jtcys);
