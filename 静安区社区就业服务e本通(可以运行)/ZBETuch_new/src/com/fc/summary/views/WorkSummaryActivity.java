...
public class WorkSummaryActivity extends Activity implements
	...
	private String rootPath = Environment.getExternalStorageDirectory()
			.toString() + File.separator + "WORKVIDEOS";// "/sdcard/sdcard"; //
														// rootPath：起始文件夹
				...
				if (files[i].isFile()) {
					...
					if (index > 0) {
						...
						if (type != null) {
							...
							myfile.setFileBitmap(getVideoThumbnail(
									files[i].getPath(), 120, 120,
	...
	private Handler handler_workvideo = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0x3000:
				DismissDialog();
				workSummaryAdapter = new WorkSummaryAdapter(
						WorkSummaryActivity.this, list_file);
