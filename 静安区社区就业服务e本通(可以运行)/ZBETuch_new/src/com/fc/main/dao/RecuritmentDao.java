...
public class RecuritmentDao {
	...
	/**
	 * 推荐个人 master_id招聘会 code岗位编码 sfz身份证
	 * 
	 * @param data
	 * @return
	 */
	public String getRecritmentGeRenInfo(Map<String, String> data) {
		String url = "/Json/Set_JobFairRecommend.aspx";
		try {
			String value = HttpUtil.postRequest(url, data);
			return value;
		} catch (ClientProtocolException e) {
	...
	/***
	 * 推荐列表 master_id招聘会 code岗位编
	 * 
	 * @return
	 */
	public String getRecritmentList(Map<String, String> data) {
		String url = "/Json/Get_JobFairRecommend.aspx";
		try {
			String value = HttpUtil.postRequest(url, data);
			return value;
		} catch (ClientProtocolException e) {
