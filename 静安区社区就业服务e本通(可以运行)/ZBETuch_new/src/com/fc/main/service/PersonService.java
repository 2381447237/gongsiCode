...
import com.fc.numcenter.views.AttentionInfoActivity;
...
import com.fc.person.views.FamilyActivity2;
	...
	Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case PersonTask.FAMILY_GETFAMILY_IMAGE:
				activity = (IActivity) getActivityByName("FamilyActivity2");
				if (activity != null) {
					activity.refresh(FamilyActivity2.REFRESH_IMAGE, msg.obj,
							msg.arg1);
				}
				break;
			...
			case PersonTask.FAMILY_GETHOUSE_IMAGE:
				activity = (IActivity) getActivityByName("FamilyActivity2");
				if (activity != null) {
					activity.refresh(FamilyActivity2.REFRESH_HOUSE_IMAGE,
							msg.obj, msg.arg1);
				}
				break;
			case PersonTask.PERSONQUERYLISTACTIVITY_GETPERSONS_BY_PARAMS:
				...
				if (activity != null) {
					activity.refresh(PersonqueryListActivity2.REFRESH_PERSON,
							msg.obj);
				}
				break;
			...
			case PersonTask.PERSONINFOMAINACTIVITY_GETPERSONBASE:
				...
				if (activity != null) {
					activity.refresh(PersoninfoMainActivity.REFRESH_PERSONBASE,
							msg.obj);
				}
				break;
			case PersonTask.PERSONINFOMAINACTIVITY_GETPERSONIMG:
				activity = (IActivity) getActivityByName("PersoninfoMainActivity");
				if (activity != null) {
					activity.refresh(PersoninfoMainActivity.REFRESH_PERSONIMG,
							msg.obj);
				}
				break;
			case PersonTask.PERSONINFOMAINACTIVITY_GETPERSONLEVEL:
				...
				if (activity != null) {
					activity.refresh(
							PersoninfoMainActivity.REFRESH_PERSONLEVEL, msg.obj);
				}
				break;
			...
			case PersonTask.MODIFYWORKINFOACTIVITY_GET_WORKINFOLIST:
				...
				if (activity != null) {
					activity.refresh(ModifyWorkInfoActivity.REFRESH_WORKINFO,
							msg.obj);
				}
				break;
