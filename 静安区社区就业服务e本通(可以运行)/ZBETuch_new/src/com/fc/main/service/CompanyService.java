...
import com.fc.main.dao.ERecordDao;
...
import com.fc.main.dao.MeetGuanLiDao;
...
import com.fc.numcenter.views.LoginInfoActivity;
import com.fc.numcenter.views.MeetingReadActivity;
import com.fc.numcenter.views.NumCenterActivity;
import com.fc.numcenter.views.RedecodeActivity;
import com.fc.numcenter.views.WorkInfoActivity;
import com.fc.numcenter.views.WorkReadGroupActivity;
...
import com.fc.recruitment.views.RecuritmentListTuiJianGeRen;
import com.fc.recruitment.views.RecuritmentListTuijianList;
...
public class CompanyService extends Service implements Runnable, IService {
	...
	MeetGuanLiDao meetGuanliDao = new MeetGuanLiDao();
	Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case CompanyTask.GRADENTPERSONINFOACTIVITY_GET_STREETLIST:
				...
				if (activity != null) {
					activity.refresh(GradeateListActivity.REFRESH_STREETLIST,
							msg.obj);
				}
				break;
			...
			case CompanyTask.GRADEATEPERSONINFOACTIVITY_GET_PERSONINFO:
				...
				if (activity != null) {
					activity.refresh(
							GradeatePersonInfoActivity.REFRESH_GRADEATEPERSONINFO,
							msg.obj);
				}
				break;
			case CompanyTask.GRADEATE_EDITWORKMARKACTIVITY_GET_COMMITTEESTAFFLIST:
				...
				if (activity != null) {
					activity.refresh(
							GradeateEditWorkMarkActivity.REFRESH_CBOINQUIRER,
							msg.obj);
				}
				break;
			case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_GANGWEILEIBIE:
				...
				if (activity != null) {
					activity.refresh(
							GradeateParamQueryActivity.REFRESH_COMPROPERTY,
							msg.obj);
				}
				break;
			case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_HANGYELEIBIE:
				...
				if (activity != null) {
					activity.refresh(
							GradeateParamQueryActivity.REFRESH_INDUSTRYCATAGORY,
							msg.obj);
				}
				break;
			case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_STREETLIST:
				...
				if (activity != null) {
					activity.refresh(
							GradeateParamQueryActivity.REFRESH_STREETLIST_QUERY,
							msg.obj);
				}
				break;
			case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_JUWEIHUILIST:
				...
				if (activity != null) {
					activity.refresh(
							GradeateParamQueryActivity.REFRESH_JUWEIHUILIST_QUERY,
							msg.obj);
				}
				break;
			case CompanyTask.RECRUITMENT_RecuritmentListActivity_GET_RECRUITMENTLIST:
				...
				if (activity != null) {
					activity.refresh(RecuritmentListActivity.REFRESH_ZPLIST,
							msg.obj);
				}
				break;
			case CompanyTask.RECRUITMENT_RecuritmentListDetailAcityity_GET_ALLINVITEJOB:
				...
				if (activity != null) {
					activity.refresh(
							RecuritmentListDetailActivity.GET_ITEMS_ALL,
							msg.obj);
				}
				break;
			case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GET_JOBFAIR:
				activity = (IActivity) getActivityByName("RecuritmentListDetailActivity");
				if (activity != null) {
					activity.refresh(RecuritmentListDetailActivity.GET_JOBFAIR,
							msg.obj);
				}
				break;
			case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_SET_JOBFAIR:
				activity = (IActivity) getActivityByName("RecuritmentListDetailActivity");
				if (activity != null) {
					activity.refresh(RecuritmentListDetailActivity.SET_JOBFAIR,
							msg.obj);
				}
				break;

			case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN:
				activity = (IActivity) getActivityByName("RecuritmentListTuiJianGeRen");
				if (activity != null) {
					activity.refresh(
							RecuritmentListTuiJianGeRen.SET_GENRENTUIJIAN,
							msg.obj);
				}
				break;

			case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_TUIJIANLIEBIAO:
				activity = (IActivity) getActivityByName("RecuritmentListTuijianList");
				if (activity != null) {
					activity.refresh(RecuritmentListTuijianList.TUI_JIAN_LIST,
							msg.obj);
				}
				break;

			case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN_QUEDING:
				activity = (IActivity) getActivityByName("RecuritmentListTuiJianGeRen");
				if (activity != null) {
					activity.refresh(
							RecuritmentListTuiJianGeRen.SET_TUIJIANGEREN_QUEDING,
							msg.obj);
				}
				break;
			...
			case CompanyTask.MEETINGPOST_MEETINGLISTACTIVITY_GET_MEETING_MASTER:
				...
				if (activity != null) {
					activity.refresh(MeetingListActivity.GET_MEETING_MASTER,
							msg.obj);
				}
				break;
			case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_SET_MEETING_CHECK:
				...
				if (activity != null) {
					activity.refresh(
							MeetingListDetailActivity.SET_MEETING_CHECK,
							msg.obj);
				}
				break;
			case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_CHECK:
				...
				if (activity != null) {
					activity.refresh(
							MeetingListDetailActivity.GET_MEETING_CHECK,
							msg.obj);
				}
				break;
			case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_FILE:
				activity = (IActivity) getActivityByName("MeetingListDetailActivity");
				if (activity != null) {
					activity.refresh(MeetingListDetailActivity.REFRESH_FILE,
							msg.obj);
				}
				break;
			case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_DOWNLOADITEM:
				activity = (IActivity) getActivityByName("MeetingListDetailActivity");
				if (activity != null) {
					activity.refresh(MeetingListDetailActivity.SHOW_FILE,
							msg.obj);
				}
				break;
			...
			case CompanyTask.MEETINGPOST_MEETINGLISTACTIVITY_GET_METTING_READ:
				activity = (IActivity) getActivityByName("MeetingListActivity");
				if (activity != null) {
					activity.refresh(MeetingListActivity.GET_MEETING_READ,
							msg.obj);
				}
				break;

			case CompanyTask.MEETINGGUANLI_GET_MEETINGGUANLINUM:
				activity = (IActivity) getActivityByName("GuanLiDetailActivity");
				if (activity != null) {
					activity.refresh(
							GuanLiDetailActivity.GET_MEETING_GUANLI_READ,
							msg.obj);
				}
				break;
			...
			case CompanyTask.NUM_CENTER_INFO:
				activity = (IActivity) getActivityByName("NumCenterActivity");
				if (activity != null) {
					activity.refresh(NumCenterActivity.REFRESH_PERSON, msg.obj);
				}
				break;
			...
			case CompanyTask.NUM_CENTER_NAME_IFNO:
				activity = (IActivity) getActivityByName("NumCenterActivity");
				if (activity != null) {
					activity.refresh(NumCenterActivity.REFRESH_PERSON_NAME,
							msg.obj);
				}
				break;
			...
			case CompanyTask.WORK_INFO:
				...
				if (activity != null) {
					activity.refresh(WorkInfoActivity.REFRESH_WORKTODATE,
							msg.obj);
				}
				break;
			...
			case CompanyTask.WORK_READ_GROUP:
				...
				if (activity != null) {
					activity.refresh(WorkReadGroupActivity.REFRESH_INFO,
							msg.obj);
				}
				break;
			...
			case CompanyTask.ADD_INFO:
				...
				if (activity != null) {
					activity.refresh(
							GradeateWorkMarkActivity.REFRESH_ADD_JOBMARK,
							msg.obj);
				}
				break;
			...
			case CompanyTask.ADD_GRADEINFO:
				...
				if (activity != null) {
					activity.refresh(
							GradeateWorkGrideActivity.REFRESH_ADD_JOBMARK,
							msg.obj);
				}
				break;
			}
	...
	public void doTask(CompanyTask task) {
		...
		case CompanyTask.QUERYFIRSTACTIVITY_GET_RESOURCELIST:
			...
			break;
		case CompanyTask.GETPERSONACTIVITY_GET_LINELEVEL:
			String linelevel = companyDao
					.getLineLevel((Map<String, String>) task.getParams().get(
							"data"));
		...
		case CompanyTask.GRADEATEWORKGRIDEACTIVITY_DELETE_JOBGRIDE:
			...
			bundle2.putString("ID", ((Map<String, String>) task.getParams()
					.get("data")).get("ID"));
		...
		case CompanyTask.GRADEATEPERSONINFOACTIVITY_GET_PERSONINFO:
			...
			break;
		case CompanyTask.GRADEATE_EDITWORKMARKACTIVITY_GET_COMMITTEESTAFFLIST:
			String str57 = gradeateDao
					.getCommitteeStaffList((Map<String, String>) task
							.getParams().get("data"));
			message.obj = str57;
			break;
		case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_GANGWEILEIBIE:
		...
		case CompanyTask.GRADEATE_GradeateParamQueryActivity_GET_JUWEIHUILIST:
			...
			break;
		case CompanyTask.RECRUITMENT_RecuritmentListActivity_GET_RECRUITMENTLIST:
			String str62 = recuritmentDao
					.getRecuritmentList((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = str62;
			break;
		case CompanyTask.RECRUITMENT_RecuritmentListDetailAcityity_GET_ALLINVITEJOB:
			String str63 = recuritmentDao
					.getRecuritmentDetailList((Map<String, String>) task
							.getParams().get("data"));
			message.obj = str63;
			break;
		case CompanyTask.SECURITY_FIRSTPAGEACTIVITY_SENDAPP:
			...
			break;
		case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GET_JOBFAIR:
			String str65 = recuritmentDao
					.getJobFairCheck((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = str65;
			break;
		case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_SET_JOBFAIR:
			String str66 = recuritmentDao
					.setJobFairCheck((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = str66;
			break;

		case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN:
			String str67 = personDao.getPersonBase(((Map<String, String>) task
					.getParams().get("data")).get("sfz"));
			message.obj = str67;
			break;

		case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_TUIJIANLIEBIAO:
			String str68 = recuritmentDao
					.getRecritmentList((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = str68;
			break;

		case CompanyTask.RECRUITMENT_RECURITMENTLISTDETAILACITYITY_GERENTUIJIAN_QUEDING:
			String str69 = recuritmentDao
					.getRecritmentGeRenInfo((Map<String, String>) task
							.getParams().get("data"));
			message.obj = str69;
			break;

		case CompanyTask.MEETINGPOST_MEETINGLISTACTIVITY_GET_MEETING_MASTER:
			String str70 = meetingPostDao
					.getMeetList((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = str70;
			break;
		case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_SET_MEETING_CHECK:
			String str71 = meetingPostDao
					.setMeetCheck((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = str71;
			break;
		case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_CHECK:
			String str72 = meetingPostDao
					.getMeetCheck((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = str72;
			break;
		case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_FILE:
			String str73 = meetingPostDao
					.getMeetFile(((Map<String, String>) task.getParams().get(
							"data")));
			message.obj = str73;
			break;
		case CompanyTask.MEETINGPOST_MEETINGLISTDETAILACTIVITY_GET_METTING_DOWNLOADITEM:
			String str74 = fileDownLoadDao.downLoadFile(task.getParams()
					.get("path").toString().trim());
			message.obj = str74;
			break;
		case CompanyTask.FIRST_FIRSTPAGEACTIVITY_GET_MEETING_MASTER:
			String str75 = meetingPostDao
					.getMeetList((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = str75;
			break;
		case CompanyTask.MEETINGPOST_MEETINGLISTACTIVITY_GET_METTING_READ:
			String str76 = meetingPostDao.getMeetingRead();
			message.obj = str76;
			break;
		case CompanyTask.GUANLIACTIVITY_SET_MEET_DATA:
			String valueStr77 = meetGuanliDao
					.setMeetGuanLi((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = valueStr77;
			break;

		case CompanyTask.ERECORD_ERECORDACTIVITY_GET_ERECORDINFO:
			String str79 = eRecordDao.getERecordInfo((Map<String, String>) task
					.getParams().get("data"));
			message.obj = str79;
			break;

		case CompanyTask.MEETINGGUANLI_GET_MEETINGGUANLINUM:
			String valueStr80 = meetGuanliDao
					.setMeetGuanLi((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = valueStr80;
			break;

		case CompanyTask.DETEL_PERSON:
			message.obj = ((Map<String, String>) task.getParams().get("data"))
					.get("position");
			break;

		case CompanyTask.NUM_CENTER_INFO:
			byte[] data1 = firstDao.getStaffImg();
			message.obj = data1;
			break;

		case CompanyTask.NUM_CENTER_NAME_IFNO:
			String staffStrs = firstDao.getStaff();
			message.obj = staffStrs;
			break;

		case CompanyTask.WORK_INFO:
			String valueStr84 = workToDateDao
					.getWorkDateList((Map<String, String>) task.getParams()
							.get("data"));
		...
		case CompanyTask.LOGIN_INFO:
			String valueStr85 = workToDateDao
					.getLoginInfo((Map<String, String>) task.getParams().get(
							"data"));
			message.obj = valueStr85;
			break;

		case CompanyTask.WORKS_INFO:
			String valueStr86 = workToDateDao
					.getLoginInfosString((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = valueStr86;
			break;

		case CompanyTask.MEETING_READ_GROUP:
			String valueStr87 = meetingPostDao.getMeetingReadGroup();
			message.obj = valueStr87;
			break;

		case CompanyTask.WORK_READ_GROUP:
			String valueStr88 = workDao
					.getWorkReadNumGroup((Map<String, String>) task.getParams()
							.get("data"));
			message.obj = valueStr88;
			break;
		...
		case CompanyTask.GRADENTPERSONINFOACTIVITY_GET_JUWEIHUILIST1:
			...
			break;
		case CompanyTask.UPDATE_INFO:
			message.obj = task.getParams().get("updatejobMarkInfo");
			break;
		...
		case CompanyTask.UPDATE_GRADEINFO:
			message.obj = task.getParams().get("updatejobGrideInfo");
			break;
		case CompanyTask.ADD_GRADEINFO:
	...
	public void onCreate() {
		super.onCreate();
		Log.v("CompanyService", "Star CompanyService");
	...
	public void onDestroy() {
		super.onDestroy();
		Log.v("CompanyService", "stop CompanyService");
		isrun = false;
	...
	public void exitApp(Context context) {
		...
		Intent intent = new Intent("com.fc.company.newservice.CompanyService");
