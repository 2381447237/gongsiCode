...
public class MeetingAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			itemHodler.tv_meetid = (TextView) convertView
					.findViewById(R.id.tv_meetid);
			itemHodler.tv_meetname = (TextView) convertView
					.findViewById(R.id.tv_meetname);
			itemHodler.tv_meetaddress = (TextView) convertView
					.findViewById(R.id.tv_meetaddress);
			itemHodler.tv_meettime = (TextView) convertView
					.findViewById(R.id.tv_meettime);
		...
		itemHodler.tv_meettime.setText(meetingInfo.getMeetingTime().replace(
				"T", " "));
