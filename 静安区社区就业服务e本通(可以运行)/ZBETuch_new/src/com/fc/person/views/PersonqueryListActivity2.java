...
public class PersonqueryListActivity2 extends Activity implements IActivity,
		OnPullDownListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (currentSty) {
		case PersonqueryListActivity2.FLAG_FROM_PERSONINFO:
	...
	public void refresh(Object... params) {
		...
		case PersonqueryListActivity2.REFRESH_PERSON:
			if (params[1] != null) {
				...
				if (personinlist != null && personinlist.size() > 0) {
					lblNum.setText("共有" + personinlist.get(0).getRecordCount()
							+ "人");
				} else {
					lblNum.setText("共有0人");
				}
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			Intent itemIntent = new Intent(PersonqueryListActivity2.this,
	...
	private void getPageList(int index) {
		...
		case PersonqueryListActivity2.FLAG_FROM_PERSONINFO:
			if (data != null) {
				...
				PersonTask task = new PersonTask(
						PersonTask.PERSONQUERYLISTACTIVITY_GETPERSONS_BY_PARAMS,
						params);
		...
		case PersonqueryListActivity2.FLAG_FROM_COMPANY:
			if (data != null) {
				...
				params.put("data", data);
				PersonTask task = new PersonTask(
						PersonTask.PERSONQUERYLISTACTIVITY_GETPERSONS_BY_COMPANY,
						params);
				PersonService.newTask(task);
			}
			break;
		case PersonqueryListActivity2.FLAG_FROM_RESOURCES:
			if (data != null) {
				...
				PersonTask task = new PersonTask(
						PersonTask.PERSONQUERYLISTACTIVITY_GETPERSONS_BY_RESOURCES,
						params);
				PersonService.newTask(task);
			}
			break;
			...
			if (value.length() > 0) {
				...
				if (jsonArray != null && jsonArray.length() > 0) {
					for (int i = 0; i < jsonArray.length(); i++) {
						...
						person.setPersonlistBorn(object.getString("birth_date")
								.split("t")[0].trim());
						...
						person.setPersonlistCurrentStatus(object
								.getString("isverify"));
						person.setPersonlistEducation(object
								.getString("cultural_code"));
