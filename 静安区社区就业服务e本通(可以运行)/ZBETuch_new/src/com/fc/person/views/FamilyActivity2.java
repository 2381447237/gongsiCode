...
public class FamilyActivity2 extends Activity implements IActivity {
	...
	public void refresh(Object... params) {
		...
		case FamilyActivity2.REFRESH_FAMILY:
			familys.clear();
			...
			break;
		case FamilyActivity2.REFRESH_IMAGE:
			...
			break;
		case FamilyActivity2.REFRESH_HOUSES:
			houses.clear();
			...
			break;
		case FamilyActivity2.REFRESH_HOUSE_IMAGE:
	...
	private class MyOnItemLongClickListener implements OnItemLongClickListener {
		...
		public boolean onItemLongClick(AdapterView<?> arg0, View view,
			...
			if (childPos != -1) {
				Builder builder = new Builder(FamilyActivity2.this);
				builder.setMessage("查看详细信息！");
				builder.setPositiveButton("查看", new OnClickListener() {

					@Override
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(FamilyActivity2.this,
								PersoninfoMainActivity.class);
						intent.putExtra("mysfz",
								childList.get(groupPos).get(childPos).getSfz());
						startActivity(intent);
						FamilyActivity2.this.finish();
					}
				});
