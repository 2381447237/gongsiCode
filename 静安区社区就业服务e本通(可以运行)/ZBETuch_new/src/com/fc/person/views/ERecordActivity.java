...
public class ERecordActivity extends Activity implements IActivity,
		OnPullDownListener {
	...
	public void refresh(Object... params) {
		...
		case ERECORD_INFO:
			if (!"".equals(params[1].toString().trim())
				...
				List<ERecordInfo> newInfos = parseJsonToInfo(params[1]
						.toString().trim());
				if (newInfos.size() > 0) {
	...
	private void getPageList(int index) {
		...
		CompanyTask task = new CompanyTask(
				CompanyTask.ERECORD_ERECORDACTIVITY_GET_ERECORDINFO, params);
