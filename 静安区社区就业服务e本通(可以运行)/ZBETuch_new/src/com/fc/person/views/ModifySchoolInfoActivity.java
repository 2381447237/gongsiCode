...
public class ModifySchoolInfoActivity extends Activity implements IActivity {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent modifyit = new Intent(ModifySchoolInfoActivity.this,
	...
	private void refreshSchoolInfo() {
		...
		PersonTask task = new PersonTask(
				PersonTask.MODIFYSCHOOLINFOACTIVITY_GET_SCHOOLINFOLIST, params);
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.btnNew:
				Intent intent = new Intent(ModifySchoolInfoActivity.this,
