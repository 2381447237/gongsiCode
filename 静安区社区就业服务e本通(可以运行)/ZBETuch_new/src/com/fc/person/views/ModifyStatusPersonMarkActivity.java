...
public class ModifyStatusPersonMarkActivity extends Activity implements
		IActivity {
	...
	private Button button_add_markok, button_update_markok, button_markno,
			button_delete_markok;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PersonTask task = new PersonTask(PersonTask.MODIFYPERSONMARK_GET_INFOS,
				params);
	...
	public void refresh(Object... params) {
		...
		case REFRESH_INFO:
			if (!"".equals(params[1].toString().trim())
				...
				List<TypeInfo> newList = parseToJson(params[1].toString()
						.trim());
				...
				adapter = new StatusAdapter(infos,
						ModifyStatusPersonMarkActivity.this);
	...
	private void initView() {
		...
		button_update_markok = (Button) this
				.findViewById(R.id.button_update_markok);
		button_markno = (Button) this.findViewById(R.id.button_markno);
		button_delete_markok = (Button) this
				.findViewById(R.id.button_delete_markok);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			PersonTask task = new PersonTask(
					PersonTask.MODIFYPERSONMARK_TYPE_NAME, params);
			PersonService.newTask(task);
		}
		...
		builder.setTitle("温馨提示")
				...
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						params.put("data", data);
						PersonTask task = new PersonTask(
								PersonTask.MODIFYPERSONMARK_TYPE_DETAIL, params);
						PersonService.newTask(task);
	...
	private boolean checkFirm() {
		if (my_type_name.getText().toString().trim() == null
				|| "".equals(my_type_name.getText().toString().trim())) {
			Toast.makeText(ModifyStatusPersonMarkActivity.this, "名称不能为空!",
