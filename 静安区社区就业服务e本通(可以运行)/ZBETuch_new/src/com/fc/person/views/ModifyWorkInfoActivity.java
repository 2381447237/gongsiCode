...
public class ModifyWorkInfoActivity extends Activity implements IActivity {
	...
	private void refreshWorkInfo() {
		...
		PersonTask task = new PersonTask(
				PersonTask.MODIFYWORKINFOACTIVITY_GET_WORKINFOLIST, params);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			Intent modifyit = new Intent(ModifyWorkInfoActivity.this,
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			switch (v.getId()) {
			case R.id.btnNew:
				Intent intent = new Intent(ModifyWorkInfoActivity.this,
						ModifyWorkInfoDetailActivity.class);
