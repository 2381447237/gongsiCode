...
public class Zihangye {
	...
	public List<Zihangye> findAll() {
		...
		list_zihangye.add(new Zihangye("其他电子元器件与电子设备制造、装调维修工", "6089900",
				"608000"));
		...
		list_zihangye
				.add(new Zihangye("粮油食品饮料生产加工及饲料加工工", "6129900", "612000"));
		...
		list_zihangye.add(new Zihangye("其他木材加工、人造板生产及木制品制作工", "6159900",
				"615000"));
		list_zihangye.add(new Zihangye("纸制品制作工", "6160300", "616000"));
		list_zihangye
				.add(new Zihangye("其他制浆、造纸和纸制品生产加工工", "6169900", "616000"));
		...
		list_zihangye.add(new Zihangye("其他广播影视品制作播放及文物保护人员", "6199900",
				"619000"));
		...
		list_zihangye
				.add(new Zihangye("铁路、地铁运输设备操作及有关人员", "6240200", "624000"));
