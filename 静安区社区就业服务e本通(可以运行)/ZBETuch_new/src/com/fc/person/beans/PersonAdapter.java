...
public class PersonAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			markhodler.tv_bianhao = (TextView) convertView
					.findViewById(R.id.tv_markbianhao);
			markhodler.tv_markname = (TextView) convertView
					.findViewById(R.id.tv_markname);
			markhodler.tv_markbeizhu = (TextView) convertView
					.findViewById(R.id.tv_markbeizhu);
			markhodler.btn_markButton = (Button) convertView
					.findViewById(R.id.btn_markbeizhu);
		...
		markhodler.tv_markname.setText(personInfo.getType_Name().trim()
				.replaceAll(" ", ""));
		markhodler.tv_markbeizhu.setText(personInfo.getUPDATE_DATE()
				.replaceAll("T", " ").substring(0, 10));
		markhodler.btn_markButton
