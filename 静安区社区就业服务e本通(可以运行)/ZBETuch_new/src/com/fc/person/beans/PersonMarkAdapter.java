...
public class PersonMarkAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.modif,
					null);
			...
			markhodler.tv_markbeizhu = (Button) convertView
		...
		markhodler.tv_markname.setText(personMark.getPersonMarkName().trim()
				.replaceAll(" ", ""));
