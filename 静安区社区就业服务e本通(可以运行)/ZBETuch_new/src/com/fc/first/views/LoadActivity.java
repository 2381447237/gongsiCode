...
public class LoadActivity extends Activity implements AnimationListener {
	...
	private Handler handler_load = new Handler() {
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0x001:
				Toast.makeText(LoadActivity.this, des, Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 启动服务
		Intent service = new Intent("com.fc.main.newservice.MainService");
		startService(service);
		Intent service2 = new Intent("com.fc.company.newservice.CompanyService");
		startService(service2);
		Intent service3 = new Intent("com.fc.person.newservice.PersonService");
	...
	public void onAnimationStart(Animation animation) {
		Intent intent = new Intent(
				"com.fc.person.service.ShowFloatWindowService");
		startService(intent);
