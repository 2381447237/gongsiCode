	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.activity_getjobsbase, null);
			itemHodler = new QueryItemHodler();
			itemHodler.tv_jobs_first_jobname = (TextView) convertView
					.findViewById(R.id.tv_jobs_first_jobname);
			itemHodler.tv_jobs_first_modifydate = (TextView) convertView
					.findViewById(R.id.tv_jobs_first_modifydate);
		...
		itemHodler.tv_jobs_first_modifydate.setText(jobsinfo.getModifydate()
				.substring(0, jobsinfo.getModifydate().indexOf("T")));
		return convertView;
	}
