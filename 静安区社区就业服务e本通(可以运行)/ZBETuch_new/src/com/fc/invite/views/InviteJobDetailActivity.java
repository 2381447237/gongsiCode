	...
	private void refreshView(String value) {
		try {
			...
			if (jsonArray.length() > 0) {
				...
				double probendsalary = Double.parseDouble(item
						.getString("probendsalary"));
				...
				lblResponsibilities.setText(ToDBC(item.getString(
						"responsibilities").trim())
						+ "\r\n");
				lblQualifications.setText(ToDBC(item
						.getString("qualifications").trim()) + "\r\n");
				...
				// 劳务派遣
				String isdispatched = item.getString("isdispatched").trim()
						.equalsIgnoreCase("true") ? "是" : "否";
		...
		public void onClick(View v) {
			...
			case R.id.btnCheck:
				...
				intent.putExtra("flag",
						PersonqueryListActivity2.FLAG_FROM_COMPANY);
