...
public class JobGrideAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.lblRecommendDate = (TextView) convertView
					.findViewById(R.id.lblRecommendDate);
			...
			holder.llRecommend2 = (LinearLayout) convertView
					.findViewById(R.id.llRecommend2);
		...
		if (Boolean
			...
			if (info.getRecommend_date().indexOf("T") > 0) {
				holder.lblRecommendDate.setText(info.getRecommend_date()
						.substring(0, info.getRecommend_date().indexOf("T")));
			} else {
				holder.lblRecommendDate.setText(info.getRecommend_date());
			}
	...
	private class Holder {
		TextView lblCheckGride, lblGrideDate, lblGrideName, lblGrideDoc,
				lblCheckRecommend, lblRecommendCom, lblRecommendJob,
				lblRecommendDate;
