...
public class ResourcesExpandAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if(convertView==null){
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_resources_main_item, null);
		}
		...
		TextView lblManNum = (TextView) convertView.findViewById(R.id.lblManNum);
		TextView lblWomanNum = (TextView) convertView.findViewById(R.id.lblWomanNum);
		TextView lblAllNum = (TextView) convertView.findViewById(R.id.lblAllNum);
		
		if("登记失业".equals(subItems.get(groupPosition).get(childPosition).getType().trim())){
		...
		lblName.setText(subItems.get(groupPosition).get(childPosition).getName());
		lblManNum.setText(""+subItems.get(groupPosition).get(childPosition).getSum_value_man());
		lblWomanNum.setText(""+subItems.get(groupPosition).get(childPosition).getSum_value_woman());
		lblAllNum.setText(""+subItems.get(groupPosition).get(childPosition).getAll());
		return convertView;
	}
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		lblManNum.setText(""+groupItems.get(groupPosition).getSum_value_man());
		lblWomanNum.setText(""+groupItems.get(groupPosition).getSum_value_woman());
