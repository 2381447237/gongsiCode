...
import com.fc.work.beans.WorkTongZhiDownLoadAdapter;
...
public class WorkTongzhiDetail extends Activity implements IActivity{
	...
	tv_workmark,tv_worktime,tv_workcreatetime,tv_worktongzhi_name;
	...
	private void initView(){
		...
		tv_worktongzhi_name=(TextView) this.findViewById(R.id.tv_work_persons);
		...
		tv_worktime.setText(info.getNOTICE_TIME().replace("T", " ").substring(0, 16));
		tv_workcreatetime.setText(info.getCREATE_DATE().replace("T", " ").substring(0, 16));
	...
	private void getButtonUserful(){
		...
		PersonTask task = new PersonTask(PersonTask.WORKTONGZHIINFOACTIVITYDETAIL_GET_BUTTONSTATUS, params);
	...
	public void btnCheckMeetFair_OnClick(View view){
		...
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("data", data);	
		PersonTask task = new PersonTask(PersonTask.WORKTONGZHIINFOACTIVITYDETAIL_SET_BUTTONSTATUS, params);
		PersonService.newTask(task);
	}
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				long arg3) {
			String filePath = ("/"+((WorkTongDownloadInfo) adapter.getItem(position))
			...
			PersonTask task = new PersonTask(
					PersonTask.WORKTONGZHIINFOACTIVITYDETAIL_GET_DOWNFILE, params);
			PersonService.newTask(task);
			showDialog();
		}
	}
