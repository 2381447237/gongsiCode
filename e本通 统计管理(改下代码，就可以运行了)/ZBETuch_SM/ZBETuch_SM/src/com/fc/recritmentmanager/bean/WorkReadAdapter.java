...
public class WorkReadAdapter extends BaseAdapter{
	
	private Context mContext;
	private List<ReadInfo> meetingReadInfos;
	
	public WorkReadAdapter(Context mContext,
			List<ReadInfo> meetingReadInfos) {
		super();
	...
	public View getView(int position, View contentView, ViewGroup arg2) {
		...
		if (contentView==null) {
			contentView=LayoutInflater.from(mContext).inflate(R.layout.item_work_read, null);
			holderItem=new HolderItem();
			holderItem.tv_num=(TextView) contentView.findViewById(R.id.tv_meeting_num);
			holderItem.tv_meeting_all=(TextView) contentView.findViewById(R.id.tv_meeting_allnum);
			holderItem.tv_meeting_read=(TextView) contentView.findViewById(R.id.tv_meeting_readnum);
			holderItem.tv_date=(TextView) contentView.findViewById(R.id.tv_meeting_time);
			holderItem.tv_reat=(TextView) contentView.findViewById(R.id.tv_meeting_rate);
