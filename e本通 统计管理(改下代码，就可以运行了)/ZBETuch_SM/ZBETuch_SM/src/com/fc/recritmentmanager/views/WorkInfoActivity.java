...
public class WorkInfoActivity extends Activity implements IActivity,OnPullDownListener {
	...
	private class MyOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			switch(v.getId()){
			case R.id.btnAdd:
				Intent intent = new Intent(WorkInfoActivity.this,AddWorkToDateActivity.class);
	...
	private class MyOnItemClickListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View view, int position,
			...
			Intent intent = new Intent(WorkInfoActivity.this,WorkToDateDetailActivity.class);
