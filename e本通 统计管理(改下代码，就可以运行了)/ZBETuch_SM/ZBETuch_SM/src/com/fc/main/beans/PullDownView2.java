...
import com.fc.main.beans.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView2 extends LinearLayout implements OnScrollOverListener {
	...
	public PullDownView2(Context context, AttributeSet attrs) {
		super(context, attrs);
