...
public class My_ExpandableListView extends ExpandableListView implements OnScrollListener{
	...
	public My_ExpandableListView(Context context, AttributeSet attrs, int defStyle) {
...
//		measureView(headView);
	...
	/** 空的 */
	private MYOnScrollOverListener mOnScrollOverListener = new MYOnScrollOverListener() {
	...
	public void setOnScrollOverListener(
			MYOnScrollOverListener onScrollOverListener) {
	 ...
	 * 
	 */
	public interface MYOnScrollOverListener {
		/**
		 * 到达最顶部触发
		 * 
		 * @param delta
