...
import com.fc.main.beans.My_ExpandableListView.MYOnScrollOverListener;
import com.fc.zbetuch_sm.R;

public class PullDownExpandView extends LinearLayout implements MYOnScrollOverListener {
	...
	/**刷新和更多的事件接口**/
	private mOnPullDownListener mOnPullDownListener;
	...
	public PullDownExpandView(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * 刷新和获取更多事件接口
	 */
	public interface mOnPullDownListener {
...
//	}
	 ...
	 * @param listener
	 */
	public void setOnPullDownListener(mOnPullDownListener listener) {
	...
	public ExpandableListView getListView() {
		mListView.setGroupIndicator(null);//getResources().getDrawable(R.drawable.questionlist));

//		mandroid:layout_height="wrap_content"
