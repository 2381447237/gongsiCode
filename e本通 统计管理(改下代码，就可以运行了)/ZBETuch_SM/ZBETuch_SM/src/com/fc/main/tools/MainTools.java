...
//								.getApplicationLabel(info.applicationInfo));
					value+=packageManager.getApplicationLabel(info.applicationInfo)+",";
				}
...
//            Log.e(TAG, "-------------file is: " + cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.TITLE)) );
//            Log.e(TAG, "-------------path is: " + cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DATA)));
//            Log.e(TAG, "-------------display is: " + cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DISPLAY_NAME)));
				if(!cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DATA)).contains(Const.USB_PATH)){
					value+=cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.DISPLAY_NAME))+",";
				}
				cursor.moveToNext();
			}
			cursor.close();
