...
//		String public_key = "62323260";
		...
		/*Key puKey = new SecretKeySpec(pub_key, "DES"); 
		Key prKey = new SecretKeySpec(private_key, "DES"); */
	    /**加密*/  
        //向量加密
	...
	/*解密方法*/
	public static String DecryptDES(String Text,String key)throws Exception {  
