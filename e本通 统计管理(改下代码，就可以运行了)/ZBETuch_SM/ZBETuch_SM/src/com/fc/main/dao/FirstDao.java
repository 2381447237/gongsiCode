...
public class FirstDao {
	...
	public String getPendWordList(Map<String, String> data){		
		try {
			String url ="/Json/Get_PendingWork.aspx?page="+data.get("page")+"&rows="+data.get("rows")
					+""+"&type="+URLEncoder.encode(data.get("type"), "UTF-8");
	...
	public String getNewsList(Map<String, String> data){
		String url = "/Json/Get_News.aspx?page="+data.get("page")+"&rows="+data.get("rows");
		try {
			String valueString  = HttpUtil.getRequest(url);
			return valueString;
		} catch (ClientProtocolException e) {
	...
	public String getMsgboardList(Map<String, String> data){
		String url = "/Json/Get_MsgBoard_Master.aspx?page="+data.get("page")+"&rows="+data.get("rows");
		try {
			String valueString  = HttpUtil.getRequest(url);
			return valueString;
		} catch (ClientProtocolException e) {
	...
	public String getJobList(Map<String, String> data){
		String url = "/Json/GetJobs.aspx?page="+data.get("page")+"&rows="+data.get("rows");
		try {
			String valueString  = HttpUtil.getRequest(url);
			return valueString;
		} catch (ClientProtocolException e) {
	 ...
	 * @return
	 */
	public String getStaff(Map<String, String> data){
		String url = "/Json/Get_Staff.aspx?staff="+data.get("staff");
		try {
	 ...
	 * @return
	 */
	public byte[] getStaffImg(Map<String, String> datas){
		String url = "/Json/GetStaffPic.aspx?staff="+datas.get("staff");	
		try {
			byte[] data = HttpUtil.getImage(url);
			return data;
		} catch (ClientProtocolException e) {
