...
public class WorkDao {
	 ...
	 * @return
	 */
	public String setWorkTongZhi(Map<String, String> data){
		String url="/Json/Set_Work_Notice.aspx";
	 ...
	 * @return
	 */
	public String setWorkStatus(Map<String, String> data){
		String url="/Json/Set_Work_News.aspx";
		System.out.println(data.get("data"));
		String value = HttpUtil.postJson(url, data.get("data"),null);
