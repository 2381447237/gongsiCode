...
public class MainPageActivity extends ActivityGroup implements
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    locationInfolist = (ArrayList<LocationInformation>) it.getSerializableExtra("locationlist");
		initPagVeiew();
	}
	/**
	 * 初始化整体滑动界面
	...
	private void initPagVeiew() {
		...
		View view1 = getLocalActivityManager().startActivity("0", mainit).getDecorView();
		View view2 = getLocalActivityManager().startActivity("1",
				new Intent(this, MainPageOne.class).putExtra("locationlist", locationInfolist)).getDecorView();
