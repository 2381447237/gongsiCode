...
public class PersonTask {
	 ...
	 * 得到工作通知内容
	 */
	public static final int WORKTONGZHIINFOACTIVITY_GET_WORKTONGZHILIST=29;
	
	/**
	 * 读取工作通知按钮的状态
	 */
	public static final int WORKTONGZHIINFOACTIVITYDETAIL_GET_BUTTONSTATUS=30;
	/**
	 * 设置工作通知的按钮状态
	 */
	public static final int WORKTONGZHIINFOACTIVITYDETAIL_SET_BUTTONSTATUS=31;
	
	/**
	 * 得到工作通知文件的附件
	 */
	public static final int WORKTONGZHIINFOACTIVITYDETAIL_GET_DOC=32;
	
	/**
	 * 下载文件
	 */
	public static final int WORKTONGZHIINFOACTIVITYDETAIL_GET_DOWNFILE=33;
	
	/**
	 * 首页得到工作通知
	 */
	public static final int FIRST_FIRSTPAGEACTIVITY_GET_WORK=34;
	
	/**
	 * 得到工作通知书
	 */
	public static final int WORKTONGZHIINFOACTIVITYDETAIL_GET_READNUM=35;
	
	/**
	 * 首页得到工作通知
	 */
	public static final int FIRST_FIRSTPAGEACTIVITY_GET_WORK_STATUS=36;
	
	/**
	 * 得到工作动态
	 */
	public static final int WORKSTATUSINFOACTIVITY_GET_WORKSTATUSINFO=37;
	/**
	 * 得到工作动态的读取率
	 */
	public static final int WORKSTATUSINFOACTIVITY_GET_WORKSTATUSINFO_READ=38;
	
	/**
	 * 工作动态中按钮的显示状态
	 */
	public static final int WORKSTATUSINFODETAILACTIVITY_GET_WORKSTATUSINFO_STATUS=39;
	
	/**
	 * 工作动态设置为已读
	 */
	public static final int WORKSTATUSINFODETAILACTIVITY_SET_WORKSTATUSINFO_STATUS=40;
	
	/**
	 * 工作动态的文件
	 */
	public static final int WORKSTATUSINFODETAILACTIVITY_GET_WORKSTATUSFILE=41;
	
	/**
	 * 下载工作动态文件
	 */
	public static final int WORKSTATUSDEATIL_GET_DOWNFILE=42;
	
	/**
	 * 得到工作动态中的留言
	 */
	public static final int WORKSTATUSDEATIL_GET_WORK_NEWS=43;
	/**
	 * 设置工作动态中的留言
	 */
	public static final int WORKSTATUSDEATIL_SET_WORK_NEWS=44;
		
	public static final int ATTENTION_INFOS=45;
	
	public static final int ZHIYUANDETAILACTIVITY_SET_SHIYE_DETAIL_INFO=46;
	
	public static final int ZHIYUANDETAILACTIVITY_SET_WUYE_DETAIL_INFO=47;
	
	public static final int ZHIYUANDETAILACTIVITY_GET_INFOS=48;
	
	public static final int ZHIYUANDETAILACTIVITY_GET_SFZ_IFNO=49;
	
	public static final int ZHIYUANDIAOCHAACTIVITY_GETZHIYUANDIAOCHAINFO=50;
	
	public static final int DELETE_FUWU_INFO=51;
	
	public static final int FUXUANGXIANGKA_GET_INFO=52;
	
	public static final int FUXUANG_NEW_FUWUCONTENT=53;
	
	public static final int NEW_FUWU_XUANXIANG=54;
	
	public static final int FUWUANG_UPDATE_FUWUCONTENT=55;
	
	public static final int UPDATE_FUWU_XUANXIANG=56;
	
	public static final int MODIFYPERSONMARK_TYPE_INFO=57;
	
	public static final int MODIFYPERSONMARK_GET_PERSONINFOS=58;
	
	public static final int MODIFYPERSONMARK_GET_TYPE_INFO=59;
	
	public static final int MODIFYPERSONMARK_INFO=60;
	
	public static final int MODIFYPERSONMARK_TYPE_NAME=61;
	
	public static final int MODIFYPERSONMARK_GET_INFOS=62;
	
	public static final int MODIFYPERSONMARK_TYPE_DETAIL=63;
	
	public static final int FIRST_FIRST_INFOS=64;
	
	public static final int REFRESH_INFO=65;
	
	public static final int QIHANGDIAOCHAOACTIVITY_GET_INFOS=66;
	
	public static final int QIHANGACTIVITY_GET_SFZ_IFNO=67;
	
	public static final int ZHIYUANDETAILACTIVITY_SET_QH_DETAIL_INFO=68;
	
	public static final int WENJUANLISTACTIVITY_GET_INFO_LIST=69;
