...
public class SchoolInfoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		if(convertView==null){
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_schoolinfo_item, null);
		}
		
		TextView lblSchool = (TextView) convertView.findViewById(R.id.lblSchool);
		TextView lblEducation = (TextView) convertView.findViewById(R.id.lblEducation);
		TextView lblSpecialty = (TextView) convertView.findViewById(R.id.lblSpecialty);
		TextView lblStart_date = (TextView) convertView.findViewById(R.id.lblStart_date);
		TextView lblEnd_date = (TextView) convertView.findViewById(R.id.lblEnd_date);
