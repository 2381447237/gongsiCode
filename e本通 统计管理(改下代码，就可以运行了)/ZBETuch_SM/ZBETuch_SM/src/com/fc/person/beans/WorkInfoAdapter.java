...
public class WorkInfoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_workinfo_item, null);
		}
		
		TextView lblDw_name = (TextView) convertView.findViewById(R.id.lblDw_name);
		...
		TextView lblDw_type = (TextView) convertView.findViewById(R.id.lblDw_type);
