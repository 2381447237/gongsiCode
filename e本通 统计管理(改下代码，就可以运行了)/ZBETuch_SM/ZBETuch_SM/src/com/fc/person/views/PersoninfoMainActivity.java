...
OnCheckedChangeListener, OnClickListener, IActivity {
	...
	protected void switchModifyActivity() {
		...
		case R.id.mRadioButton5:
			Intent intentSchool = new Intent(PersoninfoMainActivity.this,ModifySchoolInfoActivity.class);
			intentSchool.putExtra("sfz", mysfz);
			startActivity(intentSchool);
			break;
			//修改工作经历
		case R.id.mRadioButton6:
			Intent intent = new Intent(PersoninfoMainActivity.this,ModifyWorkInfoActivity.class);
	...
	private void refreshSubFrm() {
		...
		if (values[0].trim().equalsIgnoreCase("true")) {
			mListView.add(getLocalActivityManager().startActivity("activity01",
					new Intent(this, AddPersonInfoActivity.class).putExtra("sfz", mysfz))
					.getDecorView());
		...
		if (values[1].trim().equalsIgnoreCase("true")) {
			mListView.add(getLocalActivityManager().startActivity(
					"activity02",
					new Intent(this, FamilyActivity.class).putExtra("mysfz",
							mysfz)).getDecorView());
		...
		if(values[2].trim().equalsIgnoreCase("true")){
			mListView.add(getLocalActivityManager().startActivity(
					"activity03",
					new Intent(this, PersonResumeActivity.class).putExtra("sfz",
							mysfz)).getDecorView());
		...
		if(values[3].trim().equalsIgnoreCase("true")){
			mListView.add(getLocalActivityManager().startActivity("activity04",
					new Intent(this, FuXuanXiangCardActivity.class).putExtra("sfz", mysfz)).getDecorView());
		...
		if(values[4].trim().equalsIgnoreCase("true")){
			mListView.add(getLocalActivityManager().startActivity("activity05",
					new Intent(this, SchoolInfoActivity.class).putExtra("mysfz",
							mysfz)).getDecorView());
		...
		if(values[5].trim().equalsIgnoreCase("true")){
			mListView.add(getLocalActivityManager().startActivity("activity06",
