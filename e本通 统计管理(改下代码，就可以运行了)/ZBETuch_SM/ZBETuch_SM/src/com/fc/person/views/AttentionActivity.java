...
public class AttentionActivity extends Activity implements IActivity,OnPullDownListener {

	PullDownView2 pdvAttention;
	...
	public void refresh(Object... params) {
		...
		case AttentionActivity.REFRESH_ATTENTIONS:
				if(params[1]!=null){
			...
			break;
		case AttentionActivity.DELETE_ATTENTION:
				if(params[1]!=null){
					String value= params[1].toString().trim();
	...
	private void initView(){
		pdvAttention = (PullDownView2) findViewById(R.id.pdvAttention);
	...
	private void getPageList(int index) {
		...
		PersonTask task = new PersonTask(PersonTask.ATTENTIONACTIVITY_GET_ATTENTIONS, params);
