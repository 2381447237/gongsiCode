...
//		data.put("", "");
//		CompanyTask task=new CompanyTask(CompanyTask.MEETINGGUANLI_GET_MEETINGGUANLINUM, params);
	...
	private class MyOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.metting_new:
				Intent intent=new Intent(GuanLiDetailActivity.this, GuanLiMainActivity.class);
				startActivity(intent);
				break;
				
			case R.id.meettj_all:
				Intent intent1=new Intent(GuanLiDetailActivity.this, MeetingListActivity.class);
