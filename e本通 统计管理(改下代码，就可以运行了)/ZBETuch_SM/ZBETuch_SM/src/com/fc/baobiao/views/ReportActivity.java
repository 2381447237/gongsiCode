...
public class ReportActivity extends Activity implements IActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		initListener();
		CompanyTask task = new CompanyTask(CompanyTask.REPORTACTIVITY_GET_UPDATETIME, null);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			case 1:
				...
				intent1.putExtra(
						"url",
						HttpUrls_.HttpURL + "/Chart/Chart_committee.aspx?staff="
								+ MainService.STAFFID + "&type="
								+ URLEncoder.encode("登记失业"));
			...
			case 2:
				...
				intent2.putExtra(
						"url",
						HttpUrls_.HttpURL + "/Chart/Chart_age.aspx?staff="
								+ MainService.STAFFID + "&type="
								+ URLEncoder.encode("登记失业"));
