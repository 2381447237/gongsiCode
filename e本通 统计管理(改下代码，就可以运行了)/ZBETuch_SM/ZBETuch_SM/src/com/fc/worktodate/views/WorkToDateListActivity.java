...
public class WorkToDateListActivity extends Activity implements IActivity,OnPullDownListener {
	
	private WorkToDateAdapter adapter;
	private List<WorkToDateItem> allList = new ArrayList<WorkToDateItem>();
	private PullDownView2 pdvWorkToDate;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_worktodate_list);
		index=0;
		init();
		initView();
		initPdv();
	...
	public void refresh(Object... params) {
		...
		case WorkToDateListActivity.REFRESH_WORKTODATE:
			if(index==0){
				allList.clear();
	...
	private void initView(){
		...
		pdvWorkToDate = (PullDownView2) findViewById(R.id.pdvWorkToDate);
	...
	private void getMoreList(int index) {
		...
		CompanyTask task = new CompanyTask(
				CompanyTask.WORKTODATELISTACTIVITY_GET_WORKDATELIST, params);
	...
	private class MyOnClickListener implements OnClickListener{
		...
		public void onClick(View v) {
			switch(v.getId()){
			case R.id.btnAdd:
				Intent intent = new Intent(WorkToDateListActivity.this,AddWorkToDateActivity.class);
	...
	private class MyOnItemClickListener implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View view, int position,
			...
			Intent intent = new Intent(WorkToDateListActivity.this,WorkToDateDetailActivity.class);
