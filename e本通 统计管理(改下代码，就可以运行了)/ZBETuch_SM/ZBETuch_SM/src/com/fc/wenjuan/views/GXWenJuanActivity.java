...
public class GXWenJuanActivity extends Activity implements IActivity,
		OnPullDownListener {
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				long arg3) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(context, GXWenJuanPersonActivity.class);
			intent.putExtra("id",
	...
	private void getPageInfo(int index) {
		...
		PersonTask task = new PersonTask(
				PersonTask.GXWENJUANACTIVITY_GET_WENJUANINFO, params);
