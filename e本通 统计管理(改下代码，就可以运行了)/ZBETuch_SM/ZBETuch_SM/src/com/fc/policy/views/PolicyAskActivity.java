...
public class PolicyAskActivity extends Activity implements IActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init();
		initListener();
		MainTask task = new MainTask(MainTask.POLICYASKACTIVITY_GET_POLICYTYPE, null);
	...
	public void refresh(Object... params) {
		...
		case PolicyAskActivity.REFRESH_CBOSTYLE:
			if(params[1]!=null){
				...
				MainTools.fetchSpinner(this, cboType, cboStr, "ID", "TYPE_NAME");
			}
		...
		public void onClick(View v) {
			...
			case R.id.btnAsk:
				if(checkFrm()){
					...
					data.put("typeid",""+((SpinnerItem) cboType.getSelectedItem()).getId());
					data.put("questionname", txtQuestionName.getText().toString().trim());
					data.put("questionvalue", txtQuestionValue.getText().toString().trim());
					data.put("gps", gpsInfo);
					Map<String, Object> params = new HashMap<String, Object>();
					params.put("data", data);
					CompanyTask task = new CompanyTask(CompanyTask.POLICYASKACTIVITY_SET_ASK, params);
