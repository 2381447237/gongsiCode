...
public class PendWorkActivity_ extends Activity implements OnClickListener,
	...
	private void initView() {
		...
		pdvShow = (PullDownView2) findViewById(R.id.pdvShow);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			tv_pendwork_starttime.setText(start_time.substring(0, 16));
			tv_pendwork_endtime.setText(end_time.substring(0, 16));
			builder.show();
