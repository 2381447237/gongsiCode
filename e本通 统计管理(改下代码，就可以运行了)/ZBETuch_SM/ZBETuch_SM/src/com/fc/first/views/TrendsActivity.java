...
public class TrendsActivity extends Activity {
	...
	private Handler firstpageHandler = new Handler() {
		public void handleMessage(Message msg){
			switch(msg.what){	
			case 0x230:
				pendworkadapter = new PendWorkAdapter(TrendsActivity.this, pendworklist);
	...
	Runnable pendwork_thread = new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			try {
				pendworklist = HttpUrls_.getPendingWorkJson(TrendsActivity.this, 0, 15, typecd);
	...
	private void initListener(){
		...
		pendwork_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				LayoutInflater inflater = LayoutInflater.from(TrendsActivity.this);
				//加载数据
								...
								case 0:
									new Thread(){
										...
										public void run() {
											try {
											// TODO Auto-generated method stub
											PendingWorkInformation pendworkInfo= pendworklist.get(index);
											...
											data.put("json",array.toString() );
												...
												String value = HttpUtil.postRequest("/Json/Set_PendingWork.aspx", data);												
												System.out
														.println("value===>"+value);
...
//									String postJson = HttpUrls_.PendWorkPostJson(pendworklist);
//									Log.i("flag_title", postJson.toString());
									break;
								case 1:
									//Toast.makeText(TrendsActivity.this,"暂不可用", Toast.LENGTH_SHORT);	
									Log.i("aaaaaaaaaaaaaaaaaaaaaaaa", "cccccccccccccccccccccccccccccccccccc");
									break;
								default:
									break;
								}
