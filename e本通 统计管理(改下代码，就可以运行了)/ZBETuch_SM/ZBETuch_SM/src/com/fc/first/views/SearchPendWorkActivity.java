...
public class SearchPendWorkActivity extends Activity implements IActivity,OnPullDownListener {

	EditText txtPeople, txtStartTime, txtEndTime;
	Button btnPeople, btnCheck,btnAdd;
	RadioGroup rgpType;
	RadioButton rdbNot, rdbOver;
	PullDownView2 pdvPendWork;
	ListView lvPendWork;
	...
	private void initViews() {
		...
		pdvPendWork = (PullDownView2) findViewById(R.id.pdvPendWork);
		...
		try {
			...
			new DatePickerDialog(this, new OnDateSetListener() {
				...
				public void onDateSet(DatePicker view, int year,
					...
					txt.setText(new StringBuilder().append(year).append("-").append(  
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.txtEndTime:
				...
				break;
			case R.id.btnAdd:
				Intent intent2 = new Intent(SearchPendWorkActivity.this,Add_PendworkActivity.class);
				intent2.putExtra("flag", Add_PendworkActivity.FLAG_ADDMANYPENDWORK);
	...
	private class MyOnItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			View inflater_view = inflater.inflate(R.layout.activity_pendwork,
					null);
			Builder builder = new AlertDialog.Builder(SearchPendWorkActivity.this);
