...
public class MsgBoardMasterAdapter extends BaseAdapter{
	...
	public void setMsgboardmasterlist(
			List<GetMsgBoardMaster> msgboardmasterlist) {
		this.msgboardmasterlist = msgboardmasterlist;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null ){
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_msgboardmasterbase,null);
		...
		itemHodler.tv_msgboardmaster_first_createtime.setText(masterinfo.getCreate_time().replace("T", " ").substring(0, 19));
		return convertView;
	}
	class QueryItemHodler {
		TextView tv_msgboardmaster_first_title,tv_msgboardmaster_first_createtime;
	}
