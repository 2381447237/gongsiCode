...
public class UpdateManager {
	...
	private boolean isUpdate()
	{
		...
		try { 
			...
			HttpGet get = new HttpGet("http://www.fcxx.net.cn/images/version.xml");
			HttpResponse response = httpClient.execute(get);
			InputStream inStream = response.getEntity().getContent();
			*/
			
			
			url = new URL(HttpUrls_.HttpURL+"/version_gl.xml");
			//url = new URL("http://www.fcxx.net.cn/images/version.xml");//创建version.xml的连接地址。
	...
	private int getVersionCode(Context context)
	{
		...
		try
		{
			...
			versionCode = context.getPackageManager().getPackageInfo("com.fc.zbetuch_sm", 0).versionCode;
