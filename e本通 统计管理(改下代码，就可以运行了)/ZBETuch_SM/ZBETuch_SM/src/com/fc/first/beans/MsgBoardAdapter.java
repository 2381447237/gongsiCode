...
public class MsgBoardAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		if(convertView == null ){
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_msgboard_item,null);
		...
		tv_msgboardmaster_first_createtime.setText(masterinfo.getCreate_time().replace("T", " ").substring(0,19));
