...
public class MsgBoardDetileAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_msgboarddetile, null);
		...
		itemHodler.tv_msgboarddetile_time.setText(msgboarddetile.getUpdate_date().replace("T", " ").substring(0,19));
